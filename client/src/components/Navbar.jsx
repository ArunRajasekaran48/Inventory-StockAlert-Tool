      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            <Link
              to="/products"
              className="text-white hover:text-blue-800 font-medium transition duration-200 px-4 py-2 rounded-lg hover:bg-white hover:bg-opacity-10 flex items-center space-x-2"
            >
            ...
            {isAdmin() && (
              <>
                ...
                <div className="relative">
                  <Link
                    to="/admin"
                    className="text-white hover:text-blue-800 transition duration-200 p-2 rounded-lg hover:bg-white hover:bg-opacity-10 flex items-center"
                  >
                    <svg
                      className="w-6 h-6"
                      fill="none"
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth="2"
                        d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6 6 0 00-5-5.917V4a1 1 0 00-2 0v1.083A6 6 0 006 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h16z"
                      />
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
