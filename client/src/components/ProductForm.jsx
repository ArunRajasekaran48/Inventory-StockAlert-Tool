...
const ProductForm = ({ product, onSubmit, onCancel }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900 bg-opacity-30" onClick={onCancel}>
      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-2xl w-full max-w-md mx-4" onClick={e => e.stopPropagation()}>
